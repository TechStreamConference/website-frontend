...
const lookup: RegisterDict = {
	...
	'The username field must be at least 3 characters in length.':
		'Der Name muss mindestens aus 3 Zeichen bestehen.',
	'The username field cannot exceed 30 characters in length.':
		'Der Name darf maximal aus 30 Zeichen bestehen.',

	// mail
	'The email field is required.': "Das Feld 'E-Mail' ist erforderlich.",
	'The email field must contain a valid email address.':
		'Das E-Mail-Feld muss eine gültige E-Mail-Adresse enthalten',
