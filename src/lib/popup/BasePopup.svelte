<script lang="ts">
    ...
    let event_dispatcher = createEventDispatcher();
    ...
    function check_click_outside(event: MouseEvent): void {
...
<dialog on:click={check_click_outside}
        bind:this={dialog}
        role="alertdialog"
>
    <div class="content-wrapper">
        ...
        <Button
              ...
              on:click={hide_with_dispatch}>&times;
        </Button>
        <slot />
    </div>
</dialog>
