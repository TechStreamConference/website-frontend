...
<FormWrapper classes="dashboard-speaker-talk-form {classes}"
    ...
    <div class="input-grid">
        ...
        <Paragraph classes="paragraph-gray">Beschreibe deinen Vortrag. Hier darfst du gerne etwas mehr ins Detail gehen.
            Worum geht es in deinem Vortrag? Was wird man dabei lernen? Was ist das Besondere an deinem Vortrag? Eine
        ...
        <Paragraph classes="paragraph-gray">Wähle durch Anklicken #Tags aus, die am besten zu deinem Vortrag passen. Du
            musst mindestens einen Tag auswählen. Sollten sehr viele Tags passend sein, beschränke dich am besten auf
        ...
        <Paragraph classes="paragraph-gray">Wir müssen wissen, wie lang dein Vortrag dauert, um damit später den Ablauf
            des Events planen zu können. Wähle durch Anklicken die möglichen Längen für deinen Vortrag aus. Je mehr du
            auswählst, umso flexibler können wir planen.<br/>
            Teil deines Vortrags ist auch eine Fragerunde mit Fragen der Community. Plane hierfür 5 bis 15 Minuten ein,
        ...
        <Paragraph classes="paragraph-gray">Du hast nur am ersten Tag des Events Zeit, um deinen Vortrag zu halten? Du
            kannst deinen Vortrag nicht live halten, sondern nur als Aufzeichnung bereitstellen? Dein Vortrag ist Teil
            einer Vortragsreihe, bei der die restlichen Vorträge von anderen Personen eingereicht werden? Dein Vortrag
            hat bestimmte technische Voraussetzungen, die wir im Vorfeld besprechen müssen? Teile uns solche Dinge in
